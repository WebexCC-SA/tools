...
const PageControls = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a52a526e8fae61b5ed8c6a4b72372c5d7954e181', class: "controls" }, index.h("span", { key: '8a28315a2ecc7b1dd3e6db37d9b46c2be40dc623', id: "back", onClick: this.onBack.bind(this), class: "nav btn" }, "Back"), index.h("span", { key: '0f2078fa9f323861b94b2e60093596f37cd2f229', id: "tools", class: "mag btn" }, "Tools"), index.h("div", { key: '9c7f1a6a7485dd614ac2e6efdf057a35d1fe9d20', class: "tools" }, index.h("span", { key: 'fcad6d4ff10f0b2ed8738b880f0f38f1315aec42', onClick: this.onTimeWidget.bind(this) }, "Time Widget"), index.h("span", { key: '398621b652e100952f2f87d8a6a82f4c3bb7e142', onClick: () => { this.vodTog.emit(); } }, "Toggle Video"), index.h("span", { key: '0aee41395f6377ca543d24d759dece64e85a0f5b', onClick: () => { this.wxccAuthPop.emit(); } }, "Authorization")), index.h("span", { key: 'd3b29c00a94d02fad4001cd8706719078be138cb', class: "btn", id: "guide", onClick: this.onToggleGuide.bind(this) }, "Guide"), index.h("span", { key: '359993fbf6a958c577f8e3ce6c08e065a50ab8ba', id: "next", onClick: this.onNext.bind(this), class: "nav btn" }, "Next")));
    }
};
