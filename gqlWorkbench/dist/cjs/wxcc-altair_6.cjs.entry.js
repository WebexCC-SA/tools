...
const wxccAltair = class {
    ...
    render() {
        return (index.h("div", { key: '2c61a09b55eacd0b6bb1038d1edacaf2d14841cc', id: "frame" }, index.h("iframe", { key: '415aa466ca4eb252177ac4e61508381730178f5f', src: "https://webexcc-sa.github.io/tools/gqlWorkbench/altair-static/index.html", height: "100%", width: "100%", frameborder: "0", loading: "lazy" })));
    }
};
...
const wxccAuth = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'c98637edf2bb946730bbabca6668470f4dbbe742', class: "frame" + (this.hide ? " hidden" : "") }, index.h("h1", { key: 'c996f9dfba2122296ce6da43036ad63a2b4289b5' }, "Copy this text into your Global Environment Variable"), index.h("p", { key: '6896c243d64f9504ac53ce5ccff20eac27d0f199' }, tok), index.h("br", { key: 'b7ff33ad43616466635f716e022f559161aeedf2' }), index.h("center", { key: 'e3aea53a834ed0aff4bb5f90fc1e94bbb8197e53' }, index.h("button", { key: '3a2e603ae419d498ebb719b133577fd382a40db3', onClick: () => { navigator.clipboard.writeText(tok); } }, "Copy"), index.h("button", { key: 'f9c9b04a7cb55d2970fe5b3e24d823982aadce0f', onClick: () => { this.hide = !this.hide; } }, "Close")))
        ];
    }
};
...
const SideDrawer = class {
    ...
    render() {
        const fIcon = index.h("svg", { key: 'a3e5e7de31cfbbdce5e21311ce829fab8bff6c41', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, index.h("path", { key: 'e8c135d8bc853d2e7b393df2e8de546863ac8dfc', d: "M32 96l320 0V32c0-12.9 7.8-24.6 19.8-29.6s25.7-2.2 34.9 6.9l96 96c6 6 9.4 14.1 9.4 22.6s-3.4 16.6-9.4 22.6l-96 96c-9.2 9.2-22.9 11.9-34.9 6.9s-19.8-16.6-19.8-29.6V160L32 160c-17.7 0-32-14.3-32-32s14.3-32 32-32zM480 352c17.7 0 32 14.3 32 32s-14.3 32-32 32H160v64c0 12.9-7.8 24.6-19.8 29.6s-25.7 2.2-34.9-6.9l-96-96c-6-6-9.4-14.1-9.4-22.6s3.4-16.6 9.4-22.6l96-96c9.2-9.2 22.9-11.9 34.9-6.9s19.8 16.6 19.8 29.6l0 64H480z" }));
        let mainContent = this.content || index.h("slot", { key: 'a814fa10d7d2e083fd36f1cf4e39edf8e19a5fee' });
        if (this.showNav) {
            mainContent = index.h("ul", { key: 'fb78cfd1c56f2995fd3b381ce43133ea424060cf', class: "nav" }, this.lessons.map(lesson => (index.h("li", { class: "nav", onClick: this.onChoice.bind(this, lesson.url) }, index.h("strong", null, lesson.title)))));
        }
        return [
            // <div class="backdrop" onClick={this.onCloseDrawer.bind(this)}/>,
            index.h("aside", { key: '746329257cf2c307abab6d28909acb03d6a680a7' }, index.h("header", { key: '39dcd752c479fa4565e5c31109c15a4663cf1464' }, index.h("h1", { key: '5f962cec0a4daefcb4e9834a2cd451dd77e034c2', class: "post-title" }, this.currentPage || this.arttitle, " ", index.h("span", { key: 'db47231f5dc8c004415b751601e1adeb38c39a0b', class: "flipper", onClick: () => this.flip = !this.flip }, fIcon))), index.h("section", { key: '9284ebc4ff8a5205fea5bcaa37c8348551f0950c', id: "tabs" }, index.h("button", { key: '47920a9f19c9054eb2ab4bda880c09992de28510', class: !this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "lesson") }, "Lesson"), index.h("button", { key: 'f975201f1be38c972b5a36a9eb93363b69834d30', class: this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "nav") }, "Navigation")), index.h("main", { key: '4935fcf7072e30ece77f161886b19c77b49398bc' }, mainContent))
        ];
    }
};
...
const PageControls = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.wxccGuidePageTurn = index.createEvent(this, "wxccGuidePageTurn");
        this.toggleGuide = index.createEvent(this, "toggleGuide");
        this.wxccTimeWidget = index.createEvent(this, "wxccTimeWidget");
        this.wxccAuthPop = index.createEvent(this, "wxccAuthPop");
        this.vidPop = index.createEvent(this, "vidPop");
        this.vodTog = index.createEvent(this, "vodTog");
    }
    onToggleGuide() {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a52a526e8fae61b5ed8c6a4b72372c5d7954e181', class: "controls" }, index.h("span", { key: '8a28315a2ecc7b1dd3e6db37d9b46c2be40dc623', id: "back", onClick: this.onBack.bind(this), class: "nav btn" }, "Back"), index.h("span", { key: '0f2078fa9f323861b94b2e60093596f37cd2f229', id: "tools", class: "mag btn" }, "Tools", index.h("div", { key: 'bcc0ed33c750d59337c50241162098932072e1ef', class: "tools" }, index.h("span", { key: 'ba47b7796e2b76fad3250fdbe18115276d20d3aa', onClick: this.onTimeWidget.bind(this) }, "Time Widget"), index.h("span", { key: '77ca337aa4405fb642d5a95819f58ee0cc3099ae', onClick: () => { this.vodTog.emit(); } }, "Toggle Video"), index.h("span", { key: '3bee7638c61519c8094fdb644053412aacc08c22', onClick: () => { this.wxccAuthPop.emit(); } }, "Authorization"))), index.h("span", { key: '11ed11397b395132679e010566ded0f64c167b2f', class: "btn", id: "guide", onClick: this.onToggleGuide.bind(this) }, "Guide"), index.h("span", { key: '72443767cc35d514889515af8fbfe066a4dc6835', id: "next", onClick: this.onNext.bind(this), class: "nav btn" }, "Next")));
    }
};
...
const wxccTime = class {
    ...
    render() {
        const hideIcon = index.h("svg", { key: '21ea0bf0c551408edc82bf538d5fc795ef116097', xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 640 512" }, index.h("path", { key: '83bc6272737df9c2636b8b81a97c1cbd7c636bbe', d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zm151 118.3C226 97.7 269.5 80 320 80c65.2 0 118.8 29.6 159.9 67.7C518.4 183.5 545 226 558.6 256c-12.6 28-36.6 66.8-70.9 100.9l-53.8-42.2c9.1-17.6 14.2-37.5 14.2-58.7c0-70.7-57.3-128-128-128c-32.2 0-61.7 11.9-84.2 31.5l-46.1-36.1zM394.9 284.2l-81.5-63.9c4.2-8.5 6.6-18.2 6.6-28.3c0-5.5-.7-10.9-2-16c.7 0 1.3 0 2 0c44.2 0 80 35.8 80 80c0 9.9-1.8 19.4-5.1 28.2zm51.3 163.3l-41.9-33C378.8 425.4 350.7 432 320 432c-65.2 0-118.8-29.6-159.9-67.7C121.6 328.5 95 286 81.4 256c8.3-18.4 21.5-41.5 39.4-64.8L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5zm-88-69.3L302 334c-23.5-5.4-43.1-21.2-53.7-42.3l-56.1-44.2c-.2 2.8-.3 5.6-.3 8.5c0 70.7 57.3 128 128 128c13.3 0 26.1-2 38.2-5.8z" }));
        let mainContent = index.h("div", { key: '7ece4eae9337db51dbdcf0aea5aa01e12675189d' }, " ", index.h("section", { key: '9291e6409d34f858884b355b0866c3adebd94b7a', class: "widgets" }, index.h("div", { key: '408c996ded550bebd258b1d00b5bf62f440d71dc' }, index.h("label", { key: '497bd9d4b848aecde1223e4c4edfc6f74ee1a151', id: "from" }, "From: "), index.h("input", { key: '090b81e9e01eb9132c8bee4fb317946176a4e0f2', type: "date", onChange: this.onManSet.bind(this, "from"), ref: el => this.fDate = el }), index.h("input", { key: '5fbe72415ed8562abb9948eef3e0e267259b4147', type: "time", onChange: this.onManSet.bind(this, "from"), ref: el => this.fTime = el }), index.h("select", { key: 'b00a37261e84d5bbc5cf072c5abe08f738e876bb', ref: el => this.fromSelected = el, onChange: this.onToSelect.bind(this, "from") }, index.h("option", { key: '09c2e93c6d0efa5bb1b3adecf47d148a93d02b05' }), index.h("option", { key: '8c8a0c5980b5953f27d6b834422bbe5ca101a3d5', value: "600000" }, "10 minutes ago"), index.h("option", { key: '0043708c34cf06e87be76612c82d0bf43c615cbb', value: "3600000" }, "1 hour ago"), index.h("option", { key: 'c6bbe47f0663d0814fc71ed480b73aa944558ed4', value: "86400000" }, "1 day ago"), index.h("option", { key: '8bb7e3ff79cd9542d8ee94c8cefe93236d456b89', value: "604800000" }, "1 week ago"), index.h("option", { key: '87ea86b9016f55f578f8c33b8671bdba3bc097cc', value: "2629800000" }, "1 month ago"))), index.h("br", { key: '9150d42d947a393a3fe07d343f31772c6dfb6a58' }), index.h("div", { key: '60ac07063ce5aaf9b7d76dbf8ef41d2f49ed124a' }, index.h("label", { key: 'f9748d77a0d2b42608af3423ece33de4ab81ad0e', id: "to" }, "To: "), index.h("input", { key: '4b5c07ad7ba3d14ec76c7521c37dd0680123b01e', type: "date", onChange: this.onManSet.bind(this, "to"), ref: el => this.tDate = el }), index.h("input", { key: '77ff53f551b44bbaa773c3adc699a52a38d2cd85', type: "time", onChange: this.onManSet.bind(this, "to"), ref: el => this.tTime = el }), index.h("select", { key: '135d7c29816a3cb180e5bedf213d2fe771e99708', ref: el => this.toSelected = el, onChange: this.onToSelect.bind(this, "to") }, index.h("option", { key: '15393a25678db166c62a970f92073250d364454f' }), index.h("option", { key: '66033dfda08526fa854212fa6603ee0cd7f1fd77', value: "now" }, "Now"), index.h("option", { key: 'ced2b277b00446edaa663bd9dde62add73c06992', value: "600000" }, "10 minutes ago"), index.h("option", { key: '144a49f19d1b5117bfd5e5be8529cc71eefb1052', value: "3600000" }, "1 hour ago"), index.h("option", { key: '25ad7bc2a3299f9b8a06f8dbf1f01fb25db8bec5', value: "86400000" }, "1 day ago"), index.h("option", { key: '4b7cab26b0dea5529b7dd796d1f1d600bad9afac', value: "604800000" }, "1 week ago")))), index.h("section", { key: 'e63a20d3dd2e994b050e132e75c44105f474e995' }, index.h("p", { key: '775a3418a74a0dd3e5a311c865490f1d9af03d95' }, "from: \"", this.from, "\"", index.h("br", { key: '8ff02116532ef03e93f800a82095e8dbae02657e' }), "to: \"", this.to, "\"")));
        if (this.tab == "lookup") {
            mainContent = index.h("div", { key: 'f197f24efb562c44b0a5ab5bd10a8be477300e14' }, index.h("section", { key: 'f6c5fecce1f73e6508fa6148ccdc666952190181', id: "lup" }, index.h("label", { key: '9acfceefa174542babe5a499723343cb1cbc43d5' }, "Epoch Timestamp: \u00A0"), index.h("input", { key: '7137a7bdf45e94b762b9ac035de534b61dae3dcf', ref: el => this.lupStamp = el }), index.h("button", { key: 'dcb8c0857e75c80629012a498851353fbadb1525', onClick: this.epochToTime.bind(this) }, "Convert")), index.h("section", { key: '50fcd2862375a6a19969d66229cbef369e9aa1e1' }, index.h("p", { key: '3d805b3384eb1d9b2c37e677509f683f90f595af' }, "Timestamp: ", index.h("br", { key: '1a859edba162dd64d8c102f087b02692b4b6a820' }), index.h("br", { key: '5e5084a808d8fd966cecce56499473db9936a3a9' }), index.h("div", { key: 'a300311fef70ac7356f8f3e934606fd27572e425', id: "tmstp" }, this.tStamp))));
        }
        return [
            index.h("div", { key: '2c6f1e737640e007b7f3cc1494728e62100c80d6', class: "frame" + (this.hide ? " hidden" : "") }, index.h("header", { key: 'df4edf16940735fb336797d646dc7e9e577eea94' }, index.h("span", { key: '6c7af841531d4aaaf87bc8cbcbb9f55707e81f5f', class: "hideMe", onClick: this.onToggle.bind(this) }, hideIcon), index.h("div", { key: 'd5da9f63c5bfa123a4f67f13b63b4c8f180821f9', class: "title" }, "Time Widget")), index.h("section", { key: '02878d909da643fd34e97f3a7ca00d753f036aa4', id: "tabs" }, index.h("button", { key: 'c551e0fb7558ae375c27607ea9064ccdb36739dd', class: this.tab != "lookup" ? "active" : "", onClick: () => this.tab = "create" }, "Create"), index.h("button", { key: 'c621bbd23a1a04c2f13b7b9a9cfa00b8aefada05', class: this.tab == "lookup" ? "active" : "", onClick: () => this.tab = "lookup" }, "Lookup")), mainContent)
        ];
    }
};
...
const wxccVideoModal = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'a6ca71a35115a4dd0237ad51690294010b6a55e8', id: "cover", class: this.backDrop ? "covered" : "" }),
            index.h("div", { key: '7dac84ccb82c32a1aa1d52d31424abf1c5704df2', draggable: true, id: "my-div", ref: el => this.boxxie = el, onDragStart: () => { this.backDrop = true; }, onDragEnd: this.moveIt.bind(this), class: (this.vidBig ? "bigBoi" : "") + (this.hide ? " hidden" : "") }, index.h("div", { key: '0c6f56865c7897c2acb71dec030d183dfacec4ec', id: "my-div-header" }, index.h("span", { key: 'c89876283b0bb0380ef330534cb18c81585fa8bd', class: "hideMe", onClick: this.onToggleHide.bind(this) }, index.h("svg", { key: '438d8bce4df243836bffdeb6021f292ecac41a49', xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 640 512" }, index.h("path", { key: '6dfc0f877e01af9607e159e0bb89f0465c5958ff', d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zm151 118.3C226 97.7 269.5 80 320 80c65.2 0 118.8 29.6 159.9 67.7C518.4 183.5 545 226 558.6 256c-12.6 28-36.6 66.8-70.9 100.9l-53.8-42.2c9.1-17.6 14.2-37.5 14.2-58.7c0-70.7-57.3-128-128-128c-32.2 0-61.7 11.9-84.2 31.5l-46.1-36.1zM394.9 284.2l-81.5-63.9c4.2-8.5 6.6-18.2 6.6-28.3c0-5.5-.7-10.9-2-16c.7 0 1.3 0 2 0c44.2 0 80 35.8 80 80c0 9.9-1.8 19.4-5.1 28.2zm51.3 163.3l-41.9-33C378.8 425.4 350.7 432 320 432c-65.2 0-118.8-29.6-159.9-67.7C121.6 328.5 95 286 81.4 256c8.3-18.4 21.5-41.5 39.4-64.8L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5zm-88-69.3L302 334c-23.5-5.4-43.1-21.2-53.7-42.3l-56.1-44.2c-.2 2.8-.3 5.6-.3 8.5c0 70.7 57.3 128 128 128c13.3 0 26.1-2 38.2-5.8z" }))), index.h("svg", { key: '4c6ec2f92619cdf637ce54b6f33e632eacbdb8c3', id: "move", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "20", viewBox: "0 0 512 512" }, index.h("path", { key: 'b18c2afcf749cc015295c0eee10bce87eb84a5b9', d: "M278.6 9.4c-12.5-12.5-32.8-12.5-45.3 0l-64 64c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l9.4-9.4V224H109.3l9.4-9.4c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-64 64c-12.5 12.5-12.5 32.8 0 45.3l64 64c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-9.4-9.4H224V402.7l-9.4-9.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l64 64c12.5 12.5 32.8 12.5 45.3 0l64-64c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-9.4 9.4V288H402.7l-9.4 9.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l64-64c12.5-12.5 12.5-32.8 0-45.3l-64-64c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l9.4 9.4H288V109.3l9.4 9.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-64-64z" })), index.h("span", { key: 'd33623c8b8b4551f406e6b03b46d4c30d73cd622', class: "sizeBar", onClick: this.onToggleSize.bind(this) }, this.btnLable)), index.h("iframe", { key: '14922f61b1703a6d36ea37c24125d7ec05a9659e', src: url, height: "100%", width: "100%", frameborder: "0", loading: "lazy", allowFullScreen: true }))
        ];
    }
};
...
//# sourceMappingURL=wxcc-altair.wxcc-auth-widget.wxcc-guide-panel.wxcc-page-controls.wxcc-time.wxcc-video-modal.entry.cjs.js.map
